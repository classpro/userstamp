...
class PostsControllerTest < Test::Unit::TestCase
  ...
  def test_update_post
    ...
    assert_equal    @delynn, assigns["post"].updatorr
  end
  ...
  def simulate_second_request
    ...
    assert_equal    @nicole, @second_response.template.instance_variable_get("@post").updatorr
  end
end
...
class UsersControllerTest < Test::Unit::TestCase
  ...
  def test_update_user
    ...
    assert_equal    @hera, assigns["user"].updatorr
  end
  ...
  def simulate_second_request
    ...
    assert_equal    @zeus, @second_response.template.instance_variable_get("@user").updatorr
  end
end